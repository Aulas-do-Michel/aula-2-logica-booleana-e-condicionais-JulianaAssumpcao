...
"""
local=input("Para onde você vai viajar: ")
if local=="Estados Unidos" or local=="Argentina" or local=="Japão":
  valor_em_reais=float(input("Quantos reais você deseja converter: "))
